"""
vwap_continuation_long -- per-symbol overlay state for the dashboard.

Owns only the pieces that are actually vwap_continuation_long-specific:
...
so this module and its ORB / reversal_long counterparts don't diverge.
"""
...
# =============================================================================
# vwap_continuation_long-specific per-symbol filter results
# =============================================================================
...
def snapshot() -> dict:
    """
    vwap_continuation_long dashboard snapshot: shared overlay/fires/
    candle-timeline shape plus the per-symbol ``filters`` list.
    """
